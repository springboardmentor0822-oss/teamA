    ...
    <div className="dashboard-page">
      ...
      <div className="layout">
        <aside className="sidebar">
          ...
          <div className="menu">
            <button className="menu-item" onClick={() => onNavigate("dashboard")}>Dashboard</button>
            <button className="menu-item" onClick={() => onNavigate("petitions")}>Petitions</button>
            <button className="menu-item" onClick={() => onNavigate("polls")}>Polls</button>
            <button className="menu-item active">Officials</button>
            <button className="menu-item" onClick={() => onNavigate("reports")}>Reports</button>
            <button className="menu-item" onClick={() => onNavigate("settings")}>Settings</button>
          </div>

          <div className="help-card" onClick={() => onNavigate("help")}>Help & Support</div>
        ...
        <main className="content">
              ...
              {departments.map((department) => (
                <article key={department.name} className="official-card">
                  ...
                  <div className="official-meta">
                    <span><strong>Contact:</strong> {department.contact}</span>
                    <span><strong>Email:</strong> {department.email}</span>
                  </div>
                  <div className="official-links">
                    <a href={department.website} target="_blank" rel="noreferrer">Official Website</a>
                    <a href={department.grievance} target="_blank" rel="noreferrer">Grievance Portal</a>
                  </div>
                </article>
              ))}
            </div>
          ...
          <section className="officials-section">
            <h2 className="officials-title">Public Service & Transparency Portals</h2>
            <div className="officials-grid">
              {publicResources.map((resource) => (
                <article key={resource.title} className="official-card">
                  ...
                  <div className="official-links">
                    <a href={resource.link} target="_blank" rel="noreferrer">Visit Public Site</a>
                  </div>
                </article>
              ))}
            </div>
